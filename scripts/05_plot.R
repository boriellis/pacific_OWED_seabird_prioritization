...
p2 <- ridgeplot(ranks111, topsps_CA, spcolors_pri, "CA", 37)
p3 <- ridgeplot(ranks211, topsps_CA, spcolors_pri, "CA", 43)
p4 <- ridgeplot(ranks121, topsps_CA, spcolors_pri, "CA", 25)
p5 <- ridgeplot(ranks112, topsps_CA, spcolors_pri, "CA", 20)
