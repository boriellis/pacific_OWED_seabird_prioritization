...
extreme <- prioritizationdf %>% 
  filter(bin == "(0.611,0.816]") %>% 
  select(common_name, rescaled_propALL, rescaled_CV, rescaled_DV, iucn_status)

# Print the data frame as a styled table
kable(extreme, format = "html", col.names = c("Species", "CCS Exposure", "Collision Sensitivity", "Displacement Sensitivity", "IUCN Status"), table.attr = 'class="table table-striped"') %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
```
...
high <- prioritizationdf %>% 
  filter(bin == "(0.408,0.611]") %>% 
  select(common_name, rescaled_propALL, rescaled_CV, rescaled_DV, iucn_status)

# Print the data frame as a styled table
kable(high, format = "html", col.names = c("Species", "CCS Exposure", "Collision Sensitivity", "Displacement Sensitivity", "IUCN Status"), table.attr = 'class="table table-striped"') %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
```
...
moderate <- prioritizationdf %>% 
  filter(bin == "(0.204,0.408]") %>% 
  select(common_name, rescaled_propALL, rescaled_CV, rescaled_DV, iucn_status)

# Print the data frame as a styled table
kable(moderate, format = "html", col.names = c("Species", "CCS Exposure", "Collision Sensitivity", "Displacement Sensitivity", "IUCN Status"), table.attr = 'class="table table-striped"') %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
```
...
low <- prioritizationdf %>% 
  filter(bin == "(-0.000734,0.204]") %>% 
  select(common_name, rescaled_propALL, rescaled_CV, rescaled_DV, iucn_status)

# Print the data frame as a styled table
kable(low, format = "html", col.names = c("Species", "CCS Exposure", "Collision Sensitivity", "Displacement Sensitivity", "IUCN Status"), table.attr = 'class="table table-striped"') %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
```
